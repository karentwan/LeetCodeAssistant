...
function init() {
    ...
    if (url.includes("problemset/all")) {
        ...
        // 监听头
        var head = $("#headlessui-popover-button-18").parent().parent();
        var t = head.get(0);
        // var t = document.getElementById("headlessui-popover-button-18").parentNode.parentNode;
